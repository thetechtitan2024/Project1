    ...
    <div className='pt-20 pb-12 h-[80vh] bg-[#f0f8ff] fle '>
        <section className={style.Container}>
           <div className='bg-white max-w-[700px] mx-auto px-10 py-10 h-[70vh] rounded-lg'>
              ...
              <form className='flex gap-x-3 py-5'>
                  ...
                  <input className='py-1 px-5 text-center border-2 text-2xl font-normal w-20  bg-white text-black rounded-lg flex justify-center items-center border-orange-100' value={pageCount} disabled/>
