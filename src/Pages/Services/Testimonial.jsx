...
function ServiceTestimoial(props) {
  return (
    ...
    <div className='text-black flex flex-col lg:gap-x-10 justify-center py-10 border-2 font-[karla]  border-gray-400 rounded-xl items-start mx-auto shadow-2xl bg-white max-w-[1200px] '>
    <div className="pl-10">
