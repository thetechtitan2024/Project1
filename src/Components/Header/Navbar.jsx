...
const sidebar = <aside className="lg:hidden top-0 left-0 right-0 text-black mx-0 mb-2 w-auto h-full bg-gray-300 py-3 fixed  z-50 px-10  ">
 <div className="float-right cursor-pointer " onClick={()=>setScroll(!scroll)}> <img src={close} alt="close" className="w-10 h-10"/> </div>
  ...
  <header className={position?" z-50 h-20 fixed w-full top-5 max-w-[70%] transition-all duration-500 ease-out rounded-full bg-gray-100":"top-3 z-50 h-20 fixed w-full bg-transparent "}>
  ...
  <div className="flex">
  <div className='flex felex-wrap'><img src={worldologo} alt="worldo Assignment" className="w-96" /></div>
