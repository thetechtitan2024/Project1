...
function Footer() {
  return (
    <div className="bg-gray-600">
      <section className="py-12  overflow-visible max-w-[1300px] mx-auto md:px-0 px-3 ">
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-3 pt-5 justify-center sm:justify-start xl:px-0 px- lg:px-3 gap-10  ">
          <div className=" basis-[8rem] flex-grow">
            <h1 className="uppercase text-xl font-medium pb-1 underline ">site map</h1>
          ...
          <div className=" basis-[15rem] flex-grow">
            <h1 className="uppercase text-xl font-medium  underline pb-1">Contact Info</h1>
            <ul className=" list-none">
        ...
        <span to="tel:+911234567890">+91 1234567890</span>
              ...
              <li className="pt-1 uppercase text-xl font-medium  underline">Location</li>
          ...
          <div className="basis-[10rem] flex-grow">
            <h1 className="uppercase text-xl font-medium  underline pb-1">
